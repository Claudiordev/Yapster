...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, OrderEvent> orderConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(baseConsumerProps("data-handler-orders"));
    }
    ...
    @Bean
    public ConsumerFactory<String, HitEvent> hitConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(baseConsumerProps("data-handler-hits"));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, HitEvent> hitKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, HitEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(hitConsumerFactory());
        return factory;
    }
}
