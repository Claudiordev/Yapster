...
import com.claudiordese.session.controllers.request.LoginRequest;
import com.claudiordese.session.controllers.request.RegisterRequest;
import com.claudiordese.session.controllers.response.TokenResponse;
import com.claudiordese.session.controllers.request.RefreshTokenRequest;
import com.claudiordese.session.controllers.response.RegisterResponse;
...
public class AuthController {
    ...
    @ApiResponse(responseCode = "401", description = "Refresh token not recognized",
            content = @Content(schema = @Schema(implementation = ProblemDetail.class)))
